        ...
        <div className='w-[133%] shadow-xl md:shadow-2xl shadow-black -left-[17%] h-[300px] md:h-[40vh] lg:h-[80vh] xl:h-[100vh] relative overflow-hidden'>
            ...
            <div className='absolute inset-0 w-full  md:h-[50vh] xl:h-[120vh]'>
                <div className='bg-black bg-opacity-60 relative md:w-[70vw] lg:w-[40vw] md:top-[10%] lg:top-[20%] top-10 left-[15%] w-[90vw] md:left-[32%] lg:left-[45%] py-5 px-3 md:px-12 text-center'>
                    ...
                    <button className='bg-[#d4bb59] hover:bg-white hover:text-black hover:transition-colors bg-opacity-60 mt-[25px] text-white text-sm md:text-[22px] px-[20px] py-[5px]'>View Suits Collection</button>
                </div>
            </div>
        </div>
    )
